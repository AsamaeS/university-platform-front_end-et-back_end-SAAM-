...
"[project]/lib/mock/enrollments-mock.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/app/api/enrollments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/config/api-config.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$enrollments$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/mock/enrollments-mock.ts [app-route] (ecmascript)");
;
;
;
;
async function GET() {
    console.log("[v0] GET /api/enrollments - Using mock:", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA);
    if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$enrollments$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_ENROLLMENTS"]);
    }
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clients$2f$rest$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restClient"].get(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["REST_SERVICES"].ENROLLMENT);
...
async function POST(request) {
    console.log("[v0] POST /api/enrollments - Using mock:", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA);
    ...
    if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA) {
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$enrollments$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_ENROLLMENTS"].push(newEnrollment);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(newEnrollment);
    }
    try {
        const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clients$2f$rest$2d$client$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restClient"].post(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["REST_SERVICES"].ENROLLMENT, body);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(response.data);
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1f1c3f99._.js.map