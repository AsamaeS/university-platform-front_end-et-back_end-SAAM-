...
async function GET(request, { params }) {
    ...
    console.log("[v0] GET /api/students/:id - Using mock:", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA);
    if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA) {
        const student = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$students$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_STUDENTS"].find((s)=>s.id === id);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(student || null);
    }
    try {
        // StudentService.getStudent(etudiantId)
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clients$2f$soap$2d$client$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["studentSoapClient"].call("getStudent", {
            etudiantId: id
        });
        console.log("[v0] Student retrieved:", result);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$students$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_STUDENTS"].find((s)=>s.id === id) || null);
    } catch (error) {
...
async function PUT(request, { params }) {
    ...
    console.log("[v0] PUT /api/students/:id - Using mock:", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA);
    if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA) {
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$students$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_STUDENTS"].findIndex((s)=>s.id === id);
        if (index !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$students$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_STUDENTS"][index] = {
                ...__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$students$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_STUDENTS"][index],
                ...body
            };
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$students$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_STUDENTS"][index]);
        }
    ...
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clients$2f$soap$2d$client$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["studentSoapClient"].call("updateStudent", {
            etudiantId: id,
...
async function DELETE(request, { params }) {
    const { id } = await params;
    console.log("[v0] DELETE /api/students/:id - Using mock:", __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA);
    if (__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$config$2f$api$2d$config$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["API_CONFIG"].USE_MOCK_DATA) {
        const index = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$students$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_STUDENTS"].findIndex((s)=>s.id === id);
        if (index !== -1) {
            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2f$students$2d$mock$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["MOCK_STUDENTS"].splice(index, 1);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: true
            });
        }
    ...
    try {
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$clients$2f$soap$2d$client$2e$tsx__$5b$app$2d$route$5d$__$28$ecmascript$29$__["studentSoapClient"].call("deleteStudent", {
            etudiantId: id
        });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__21eaa8ff._.js.map